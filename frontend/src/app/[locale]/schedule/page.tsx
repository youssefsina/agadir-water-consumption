                                                        ...
                                                        {ev.status === "completed" && (
                                                            <span className="text-green-700 text-sm flex items-center gap-2">
                                                                ...
                                                                <span className="inline-flex items-center gap-1">
                                                                    <span className="font-medium">{t('completed')}:</span> {ev.action}
                                                                </span>
                                                            </span>
                                                        )}
                                                        {ev.status === "scheduled" && (
                                                            <span className="text-green-600/80 text-sm flex items-center gap-2">
                                                                ...
                                                                <span className="inline-flex items-center gap-1">
                                                                    <span className="font-medium">{t('scheduled')}:</span> {ev.action}
                                                                </span>
                                                            </span>
                                                        )}
                                                        {ev.status === "pending_ai" && (
                                                            <div className="text-orange-600 text-sm">
                                                                <span className="flex items-center gap-2 font-medium">
                                                                    <Sparkles className="w-3 h-3" /> {t('pendingAI')}
                                                                </span>
                                                        ...
                                                        {ev.status === "skipped" && (
                                                            <div>
                                                                <span className="text-gray-400 line-through text-sm">
                                                                    <span className="inline-flex items-center gap-1">
                                                                        <span className="font-medium">{t('skipped')}:</span> {ev.action}
                                                                    </span>
                                                                </span>
